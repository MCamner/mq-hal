# Claude Instructions For mq-hal
...
1. Read `/Users/mansys/mqobsidian/memory/learn/agent/mq-hal.md` if it exists.
2. Read `/Users/mansys/mqobsidian/systems/mq-hal/hot.md` if it exists.
3. Read `/Users/mansys/mqobsidian/systems/mq-hal/index.md` if it exists.
4. Read `/Users/mansys/mqobsidian/memory/learn/repos/mq-hal.md` if it exists.
